...
const IndexPage = () => {
  return (
    <Layout>
      ...
      {/* ICONS SECTION */}
      <section className='border-t border-b border-gray-500 py-24 grid grid-cols-2 md:grid-cols-4 gap-y-1.5 md:w-11/12 md:mx-auto lg:w-full lg:border-l-0 lg:border-r-0 lg:px-24'>
        <div className=''>
